...
Поддерживаемые действия: открыть YouTube/поиск, play/pause, перемотка, mute/unmute, громкость, fullscreen, next/prev, субтитры.
